...
ifeq ($(strip $(TARGET_BOOTLOADER_BOARD_NAME)),sp7731e_1h20)
PRODUCT_COPY_FILES += \
    frameworks/av/media/libstagefright/data/media_codecs_google_telephony_go.xml:$(TARGET_COPY_OUT_VENDOR)/etc/media_codecs_google_telephony.xml \
    $(LOCAL_PATH)/media_codecs_c2_go.xml:$(TARGET_COPY_OUT_VENDOR)/etc/media_codecs_c2.xml \
    $(LOCAL_PATH)/media_codecs_google_audio_go.xml:$(TARGET_COPY_OUT_VENDOR)/etc/media_codecs_google_audio.xml \
    $(LOCAL_PATH)/media_codecs_go.xml:$(TARGET_COPY_OUT_VENDOR)/etc/media_codecs.xml
else
PRODUCT_COPY_FILES += \
...
ifneq ($(wildcard vendor/partner_gms),)
  ifeq ($(strip $(TARGET_BUILD_VERSION)),gms)
    ifeq ($(strip $(PRODUCT_GO_DEVICE)),true)
      ifeq ($(strip $(GO_512)),true)
        $(call inherit-product, vendor/partner_gms/products/gms_go_512m.mk)
      else
